-- Hofino – Classroom: class_overview um Depot-Aggregate für Prozess-Challenges erweitern.
-- Weiterhin NUR grobe Zahlen je Schüler (Datenschutz, CLAUDE.md §3): keine Order-Historie,
-- keine Einzelpositionen – nur Anzahlen: getätigte Orders, verschiedene Branchen, verschiedene
-- Regionen/Länder, ETF-Positionen. Damit kann der Lehrer Streuungs-/Ruhige-Hand-/ETF-/
-- Gebühren-Challenges auswerten, ohne in die Depots zu schauen.
...
language sql stable security definer set search_path = public as $$
  select
    ...
    -- Prozess-Aggregate (nur Anzahlen):
